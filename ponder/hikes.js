...
function search(){
  ...
  let filterhikes = hikes.filter(function (hike){
    return(
      hike.name.toLowerCase().includes(uQuery.toLowerCase())||
      hike.description.toLowerCase().includes(uQuery.toLowerCase())||
      hike.tags.find(tag => tag.toLowerCase().includes(uQuery.toLowerCase()))
    )
  })
